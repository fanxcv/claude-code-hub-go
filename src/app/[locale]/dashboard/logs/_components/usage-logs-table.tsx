...
export function UsageLogsTable({
  ...
  const visibleColumnCount =
    14 - (hideReasoningEffortColumn ? 1 : 0) - (hideProtocolConversionColumn ? 1 : 0);
          ...
          <TableHeader>
            <TableRow>
              ...
              {hideProtocolConversionColumn ? null : (
                <TableHead title={t("logs.columns.protocolConversionTooltip")}>
              ...
              logs.map((log) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell className="font-mono text-xs w-[260px] max-w-[260px]">
                      <TooltipProvider>
                        <Tooltip>
                          <TooltipTrigger asChild>
