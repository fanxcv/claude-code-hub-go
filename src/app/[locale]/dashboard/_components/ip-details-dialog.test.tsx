...
const NULL_ACCURACY_RESPONSE: IpGeoLookupResponse = {
  ...
  data: {
    ...
    connection: {
      asn: 64496,
      handle: "EXAMPLE-TRANSIT-AS",
      organization: "Example Transit Ltd",
      domain: "example.net",
    ...
    company: { name: "Example Transit Ltd", domain: "example.net", type: "isp" },
    carrier: null,
    hosting: { provider: "Example Hosting", domain: "example.net", network: "198.51.100.0/24" },
    privacy: {
      is_proxy: true,
      is_vpn: false,
      is_tor: false,
