...
// max_tokens / max_output_tokens 覆写偏好（claude / codex / openai-compatible 共用）
// Values stored as JSON string: "inherit" or numeric string like "32000"
const MAX_TOKENS_PREFERENCE = z.union([
  z.literal("inherit"),
  z
    .string()
...
export const CreateProviderSchema = z
  .object({
    ...
    // 协议转换开关
    protocol_conversion_enabled: z.boolean().optional().default(false),
    ...
    codex_max_tokens_preference: MAX_TOKENS_PREFERENCE.optional().default("inherit"),
    anthropic_max_tokens_preference: MAX_TOKENS_PREFERENCE.optional().default("inherit"),
    ...
    openai_max_tokens_preference: MAX_TOKENS_PREFERENCE.optional().default("inherit"),
...
export const UpdateProviderSchema = z
  .object({
    ...
    // 协议转换开关
    protocol_conversion_enabled: z.boolean().optional(),
    context_1m_preference: CONTEXT_1M_PREFERENCE.nullable().optional(),
    ...
    codex_max_tokens_preference: MAX_TOKENS_PREFERENCE.optional(),
    anthropic_max_tokens_preference: MAX_TOKENS_PREFERENCE.optional(),
    anthropic_thinking_budget_preference: ANTHROPIC_THINKING_BUDGET_PREFERENCE.optional(),
    anthropic_adaptive_thinking: ANTHROPIC_ADAPTIVE_THINKING_CONFIG,
    openai_max_tokens_preference: MAX_TOKENS_PREFERENCE.optional(),
...
export const anthropicMaxTokensPreferenceSchema = MAX_TOKENS_PREFERENCE;
